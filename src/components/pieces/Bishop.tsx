 ...
 * Bishop icon.
 */
export default function BishopIcon({ size, isWhite }: IIconProps): JSX.Element {
    const { themeObject } = useAppTheme();
    
    return (
        <Svg width={size} height={size} viewBox="0 0 45 45" preserveAspectRatio="xMidYMid meet">
            <G stroke={isWhite ? themeObject.blackPiece : themeObject.whitePiece}>
                <G
                    fill={isWhite ? themeObject.whitePiece : themeObject.blackPiece}
                ...
                <Path
                    ...
                    fill="none"
                    stroke={isWhite ? themeObject.blackPiece : themeObject.whitePiece}
